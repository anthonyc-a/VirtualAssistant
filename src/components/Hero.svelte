...
<div
  class="max-w-3xl shadow hover:!border-border w-[calc(100%-56px)] md:w-full flex flex-col md:flex-row items-center gap-7 md:gap-10 p-6 md:!py-2 transition-all border border-border hover:bg-accent/30 dark:border-accent rounded-3xl min-h-[224px] md:min-h-[232px] mx-auto"
>
  <div

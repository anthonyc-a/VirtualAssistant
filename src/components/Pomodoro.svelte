...
{#if timer.is_active}
  <div
    class="fixed top-20 right-2 cursor-pointer w-16 h-16 hover:scale-105 z-[9999] transition-all"
    on:click={playTimer}
    role="presentation"
  ...
  <div class="container mx-auto px-4 py-8 max-w-md">
    <div
      class="bg-[#252525] bg-opacity-30 backdrop-blur-sm border border-[#252525] text-white rounded-2xl p-6 mb-6"
    >
